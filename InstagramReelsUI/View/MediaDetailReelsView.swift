...
struct MediaDetailReelsView: View {
        ...
        GeometryReader{proxy in
            ...
            TabView(selection: $currentReel){
                ...
                ForEach($reels){$reel in
                    ReelsPlayerMediaDetail(reel: $reel)
                    //setting width
...
struct MediaDetailReelsView_Previews: PreviewProvider {
    static var previews: some View {
        ContentView()
    }
}

struct ReelsPlayerMediaDetail: View{
